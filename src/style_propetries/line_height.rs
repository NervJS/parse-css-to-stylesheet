...
use crate::{
  generate_dimension_percentage, generate_invalid_expr, style_propetries::traits::ToExpr,
};
      ...
      value: match prop.1 {
        Property::LineHeight(value) => {
          match value {
            ...
            font::LineHeight::Number(val) => EnumValue::String(format!("{}%", *val * 100.0)),
