...
use super::{
  flex_basis::FlexBasis, number::NumberProperty, style_property_type::CSSPropertyType,
  traits::ToExpr, unit::PropertyTuple,
};
...
impl ToExpr for Flex {
  fn to_expr(&self) -> PropertyTuple {
    ...
    if let Some(value) = &self.value {
      ...
      PropertyTuple::One(CSSPropertyType::Invalid, generate_invalid_expr!())
    }
  }
}
