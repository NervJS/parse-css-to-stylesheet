  ...
  fn to_expr(&self) -> PropertyTuple {
    PropertyTuple::One(
      ...
      match &self.value {
        ...
        EnumValue::BREAKALL => {
          generate_expr_enum!(style_property_enum::ArkUI_WordBreak::ARKUI_WORD_BREAK_BREAK_ALL)
        }
        EnumValue::BREAKWORD => {
          generate_expr_enum!(style_property_enum::ArkUI_WordBreak::ARKUI_WORD_BREAK_BREAK_WORD)
        }
      },
    )
  }
