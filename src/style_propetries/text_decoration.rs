  ...
  fn to_expr(&self) -> PropertyTuple {
    ...
    if let Some(line) = &self.line {
      props.push((
        ...
        match line {
          TextDecorationLine::Underline => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationType::ARKUI_TEXT_DECORATION_TYPE_UNDERLINE
          ),
          TextDecorationLine::LineThrough => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationType::ARKUI_TEXT_DECORATION_TYPE_LINE_THROUGH
          ),
          TextDecorationLine::Overline => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationType::ARKUI_TEXT_DECORATION_TYPE_OVERLINE
          ),
          _ => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationType::ARKUI_TEXT_DECORATION_TYPE_NONE
          ),
        },
      ));
    }
    ...
    if let Some(style) = &self.style {
      props.push((
        ...
        match style {
          TextDecorationStyle::Solid => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationStyle::ARKUI_TEXT_DECORATION_STYLE_SOLID
          ),
          TextDecorationStyle::Double => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationStyle::ARKUI_TEXT_DECORATION_STYLE_DOUBLE
          ),
          TextDecorationStyle::Dotted => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationStyle::ARKUI_TEXT_DECORATION_STYLE_DOTTED
          ),
          TextDecorationStyle::Dashed => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationStyle::ARKUI_TEXT_DECORATION_STYLE_DASHED
          ),
          TextDecorationStyle::Wavy => generate_expr_enum!(
            style_property_enum::ArkUI_TextDecorationStyle::ARKUI_TEXT_DECORATION_STYLE_WAVY
          ),
        },
      ));
    }
