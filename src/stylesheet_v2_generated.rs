...
impl Value {
  ...
  pub const PoolString: Self = Self(1);
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::NONE => Some("NONE"),
      Self::PoolString => Some("PoolString"),
...
impl core::fmt::Debug for Selector {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("Selector")
      ...
      .field("is_string", &self.is_string())
      .finish()
  }
}

impl flatbuffers::SimpleToVerifyInSlice for Selector {}
impl<'a> flatbuffers::Follow<'a> for Selector {
  type Inner = &'a Selector;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    <&'a Selector>::follow(buf, loc)
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a Selector {
  type Inner = &'a Selector;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    flatbuffers::follow_cast_ref::<Selector>(buf, loc)
  }
}
impl<'b> flatbuffers::Push for Selector {
    type Output = Selector;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Selector as *const u8, <Self as flatbuffers::Push>::size());
...
impl<'a> flatbuffers::Verifiable for Selector {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Selector {
  ...
  pub fn new(
    ...
    let mut s = Self([0; 8]);
    s.set_string_id(string_id);
    s.set_integer_value(integer_value);
    s.set_is_string(is_string);
    s
  }
  ...
  pub fn set_string_id(&mut self, x: u32) {
  ...
  pub fn set_integer_value(&mut self, x: u8) {
    let x_le = x.to_little_endian();
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid value in this slot
  ...
  pub fn set_is_string(&mut self, x: bool) {
    let x_le = x.to_little_endian();
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid value in this slot
...
// struct PseudoKey, aligned to 1
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq)]
pub struct PseudoKey(pub [u8; 3]);
impl Default for PseudoKey { 
  fn default() -> Self { 
    Self([0; 3])
  }
}
impl core::fmt::Debug for PseudoKey {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("PseudoKey")
      .field("integer_value", &self.integer_value())
      .field("bool_value", &self.bool_value())
      .field("is_int", &self.is_int())
      .finish()
  }
}

impl flatbuffers::SimpleToVerifyInSlice for PseudoKey {}
impl<'a> flatbuffers::Follow<'a> for PseudoKey {
  type Inner = &'a PseudoKey;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    <&'a PseudoKey>::follow(buf, loc)
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a PseudoKey {
  type Inner = &'a PseudoKey;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    flatbuffers::follow_cast_ref::<PseudoKey>(buf, loc)
  }
}
impl<'b> flatbuffers::Push for PseudoKey {
    type Output = PseudoKey;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const PseudoKey as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a> flatbuffers::Verifiable for PseudoKey {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> PseudoKey {
  ...
  pub fn set_integer_value(&mut self, x: i8) {
    let x_le = x.to_little_endian();
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid value in this slot
  ...
  pub fn set_bool_value(&mut self, x: bool) {
    let x_le = x.to_little_endian();
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid value in this slot
  ...
  pub fn set_is_int(&mut self, x: bool) {
    let x_le = x.to_little_endian();
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid value in this slot
...
// struct KeyValueString, aligned to 4
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq)]
pub struct KeyValueString(pub [u8; 8]);
impl Default for KeyValueString { 
  fn default() -> Self { 
    Self([0; 8])
  }
}
impl core::fmt::Debug for KeyValueString {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("KeyValueString")
      .field("key", &self.key())
...
impl flatbuffers::SimpleToVerifyInSlice for KeyValueString {}
impl<'a> flatbuffers::Follow<'a> for KeyValueString {
  type Inner = &'a KeyValueString;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    <&'a KeyValueString>::follow(buf, loc)
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a KeyValueString {
  type Inner = &'a KeyValueString;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    flatbuffers::follow_cast_ref::<KeyValueString>(buf, loc)
  }
}
impl<'b> flatbuffers::Push for KeyValueString {
    type Output = KeyValueString;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const KeyValueString as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a> flatbuffers::Verifiable for KeyValueString {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> flatbuffers::Follow<'a> for PoolString<'a> {
  type Inner = PoolString<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl<'a> PoolString<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    PoolString { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args PoolStringArgs
  ) -> flatbuffers::WIPOffset<PoolString<'bldr>> {
    let mut builder = PoolStringBuilder::new(_fbb);
  ...
  pub fn id(&self) -> u32 {
    ...
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(PoolString::VT_ID, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for PoolString<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct PoolStringArgs {
    pub id: u32,
}
impl<'a> Default for PoolStringArgs {
  #[inline]
  fn default() -> Self {
    PoolStringArgs {
      id: 0,
...
pub struct PoolStringBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PoolStringBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
    self.fbb_.push_slot::<u32>(PoolString::VT_ID, id, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PoolStringBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<PoolString<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for PoolString<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("PoolString");
      ds.field("id", &self.id());
      ds.finish()
  }
}
...
impl<'a> StringArray<'a> {
  ...
  pub fn values(&self) -> Option<flatbuffers::Vector<'a, u32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(StringArray::VT_VALUES, None)}
  }
}
...
impl<'a> KeyValue<'a> {
  ...
  pub fn value_as_pool_string(&self) -> Option<PoolString<'a>> {
    if self.value_type() == Value::PoolString {
      self.value().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { PoolString::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Value, _>("value_type", Self::VT_VALUE_TYPE, "value", Self::VT_VALUE, false, |key, v, pos| {
        match key {
          Value::PoolString => v.verify_union_variant::<flatbuffers::ForwardsUOffset<PoolString>>("Value::PoolString", pos),
  ...
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("KeyValue");
      ...
      match self.value_type() {
        Value::PoolString => {
          if let Some(x) = self.value_as_pool_string() {
            ds.field("value", &x)
          } else {
...
impl<'a> Style<'a> {
  ...
  #[inline]
  pub fn pseudo_key(&self) -> Option<flatbuffers::Vector<'a, PseudoKey>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, PseudoKey>>>(Style::VT_PSEUDO_KEY, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn selector(&self) -> Option<flatbuffers::Vector<'a, Selector>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Selector>>>(Style::VT_SELECTOR, None)}
  }
  #[inline]
  pub fn variables(&self) -> Option<flatbuffers::Vector<'a, KeyValueString>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, KeyValueString>>>(Style::VT_VARIABLES, None)}
  }
}
...
impl flatbuffers::Verifiable for Style<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, PseudoKey>>>("pseudo_key", Self::VT_PSEUDO_KEY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("pseudo_val", Self::VT_PSEUDO_VAL, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Selector>>>("selector", Self::VT_SELECTOR, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, KeyValueString>>>("variables", Self::VT_VARIABLES, false)?
     .finish();
    Ok(())
  }
}
pub struct StyleArgs<'a> {
    ...
    pub media: u8,
    pub pseudo: u8,
    pub pseudo_key: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, PseudoKey>>>,
    pub pseudo_val: Option<flatbuffers::WIPOffset<&'a str>>,
    pub selector: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, Selector>>>,
    pub variables: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, KeyValueString>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StyleBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_pseudo_key(&mut self, pseudo_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , PseudoKey>>) {
  ...
  #[inline]
  pub fn add_selector(&mut self, selector: flatbuffers::WIPOffset<flatbuffers::Vector<'b , Selector>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Style::VT_SELECTOR, selector);
  }
  #[inline]
  pub fn add_variables(&mut self, variables: flatbuffers::WIPOffset<flatbuffers::Vector<'b , KeyValueString>>) {
...
impl<'a> StyleSheet<'a> {
  ...
  pub const VT_STRING_POOL: flatbuffers::VOffsetT = 12;
  pub const VT_DESIGN_WIDTH: flatbuffers::VOffsetT = 14;
  pub const VT_ALLOW_INHERIT: flatbuffers::VOffsetT = 16;
  ...
  #[inline]
  pub fn string_pool(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(StyleSheet::VT_STRING_POOL, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for StyleSheet<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("string_pool", Self::VT_STRING_POOL, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StyleSheetBuilder<'a, 'b, A> {
  ...
  pub fn add_string_pool(&mut self, string_pool: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StyleSheet::VT_STRING_POOL, string_pool);
  }
  #[inline]
